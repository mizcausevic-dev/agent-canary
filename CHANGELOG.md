...
### Released
- Published **agent-canary** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **agent-canary**.
...
- That insight became the basis for **agent-canary**.
