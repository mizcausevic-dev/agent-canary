...
### Released
- Released **agent-canary** publicly as a reviewable operating system for platform governance.
...
### Shipped
- Cut the first coherent internal version of **agent-canary** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Progressive rollout, shadow mode, and auto-rollback for AI agents. Sticky-percent routing with promote/rollback gates driven by real metrics. Platform engineering reliability for the agent era.
